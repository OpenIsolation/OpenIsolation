...
enum eReflectionMapQuality {
  ...
  // This state is implicit, there's no code that searches for it.
  // As long as the state is not 0 (OFF), it'll activate the reflection renderer, just with no mip-maps.

...
public:
	...
	inline void AddRef() { AKPLATFORM::AkInterlockedIncrement(&m_uRefCount); }
	inline void Release() 
	{ 		
		if (AKPLATFORM::AkInterlockedDecrement(&m_uRefCount) == 0)
		{
			Destroy();
		}
	}
...
protected:
	...
	AkAtomic32			m_uRefCount;	// Reference count
};
